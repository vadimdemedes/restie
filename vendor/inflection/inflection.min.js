...
String.prototype.titleize||(String.prototype.titleize=function(){for(var a=this.toLowerCase(),a=a.replace(InflectionJS.underbar," "),a=a.split(" "),b=0;b<a.length;b++){for(var c=a[b].split("-"),d=0;d<c.length;d++)this._non_titlecased_words.indexOf(c[d].toLowerCase())<0&&(c[d]=c[d].capitalize());a[b]=c.join("-")}a=a.join(" ");return a=a.substring(0,1).toUpperCase()+a.substring(1)});String.prototype.demodulize||(String.prototype.demodulize=function(){var a;a=this.split("::");return a=a[a.length-1]});
...
String.prototype.ordinalize||(String.prototype.ordinalize=function(){var a;a=this.split(" ");for(var b=0;b<a.length;b++)if(parseInt(a[b])===NaN){var c=a[b].substring(a[b].length-2),d=a[b].substring(a[b].length-1),e="th";c!="11"&&(c!="12"&&c!="13")&&(d==="1"?e="st":d==="2"?e="nd":d==="3"&&(e="rd"));a[b]=a[b]+e}return a=a.join(" ")});